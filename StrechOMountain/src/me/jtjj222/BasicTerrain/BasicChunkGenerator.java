...
public class BasicChunkGenerator extends ChunkGenerator {
	...
	void setBlock(int x, int y, int z, byte[][] chunk, Material material) {
		if (!(x < 16 && x >= 0 && z < 16 && z >= 0 && y < 256 && y >=0 )) return; //out of bounds
	...
	public byte[][] generateBlockSections(World world, Random rand, int ChunkX,
		...
		SimplexOctaveGenerator bottoms2 = new SimplexOctaveGenerator(world,8);
    ...
    public List<BlockPopulator> getDefaultPopulators(World world) {
        ...
        pops.add(new MetaPopulator()); //thanks codename_b for the populators!
        return pops;
    }
}
